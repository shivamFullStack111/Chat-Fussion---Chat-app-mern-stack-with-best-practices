...
const HomeSideBar = ({ active }) => {
  ...
  return (
    <div
      className={`1000px:min-w-[70px] 1000px:max-w-[70px]  h-full flex-col overflow-y-scroll bg-darkbg flex items-center  justify-evenly  ${mobileContainerClassName}`}
    >
...
export const Navs = ({ item, index, active }) => {
  ...
  return (
    ...
    >
      <Icon
        className={`hover:scale-110 transition-all duration-150  text-lg 350px:text-xl 400px:text-2xl 1000px:text-2xl`}
      />
    </Link>
  );
};
