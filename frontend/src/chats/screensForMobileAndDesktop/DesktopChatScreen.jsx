        ...
        <div className="w-full h-20 bg-[#0004]  backdrop-blur-md flex justify-between items-center">
          <div className="flex px-4 items-center gap-2">
            {conversation?.type == "group" ? (
              <img
                className="h-10 w-10 object-cover rounded-full bg-cover"
              ...
              <>
                {isImageShow && oponentUser?.profileImage ? (
                  ...
                  <div className="h-10 w-10 uppercase flex justify-center items-center rounded-full bg-pink-400 text-black ">
                    {oponentUser?.name[0]}
                  </div>
                )}
              </>
